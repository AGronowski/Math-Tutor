...
object StrokeManagerThree:AppCompatActivity() {
...
//                .build()
        ...
        recognizer.recognize(ink)
            .addOnSuccessListener { result: RecognitionResult ->
                ...
                while (mytext.toIntOrNull() == null){
                    ...
                    Log.e("Result", "prediction error: ${StrokeManager.mytext}")
                }
            }
    ...
    fun download() {
        ...
        StrokeManagerThree.model =
            DigitalInkRecognitionModel.builder(modelIdentifier!!).build()

        val remoteModelManager = RemoteModelManager.getInstance()
        remoteModelManager.download(StrokeManagerThree.model, DownloadConditions.Builder().build())
